    ...
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" style="background:url(/zxwz/images/houtaitop.png);">
		<tr>
			...
			<IFRAME style="Z-INDEX:2; VISIBILITY:inherit; WIDTH:100%; HEIGHT:100%" 
                ...
                src="<%=path %>/auser/top.jsp" frameBorder="0" noResize scrolling="no">
	        </IFRAME>
			</td>
		</tr>
		<tr>
			...
			<IFRAME style="Z-INDEX:2; VISIBILITY:inherit; WIDTH:217; HEIGHT:100%" 
               ...
               src="<%=path %>/auser/left.jsp" frameBorder="0" noResize scrolling="yes">
	        </IFRAME>
	        </td>
			...
			<td width="947" valign="top" style="width:100%">
			   <iframe frameborder="0" id="mainFrame" name="mainFrame"
			      scrolling="yes" src="<%=path %>/auser/right.jsp" style="height:100%;visibility:inherit; width:100%;z-index:1;">
			   </iframe>
			</td>
		</tr>
		<tr>
