	            ...
	            <div style="width:900px;margin-top: 1px;">
				      ...
				      <div style="height: 100%;border:1px solid #CCCCCC;">
				          <div style="padding-top: 10px;padding-left: 10px;padding-right: 10px;">
							    ...
							    <tr>
							       <td align="left">信息标题：${requestScope.gonggao.title }</td>
							    </tr>
							    <tr>
							       <td align="left" style="line-height: 200%">信息内容：<c:out value="${requestScope.gonggao.content}" escapeXml="false"></c:out></td>
							    </tr>
							    <tr>
